...
public interface INotchSupport {
     ...
     * @param activity
     */
    void fullScreenNonUseStatus(Activity activity, OnNotchCallBack notchCallBack);
     ...
     * @param notchCallBack
     */
    void fullScreenNonUseStatusForPortrait(Activity activity, OnNotchCallBack notchCallBack);
     ...
     * @param notchCallBack
     */
    void fullScreenDonUseStatusForLandscape(Activity activity, OnNotchCallBack notchCallBack);
